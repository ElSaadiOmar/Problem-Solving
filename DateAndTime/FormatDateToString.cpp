// Problem: Format a date into different custom string layouts.
// Supports formats like dd/mm/yyyy, yyyy/dd/mm, mm-dd-yyyy, and more.
...
string ReplaceWordInString(string String, string Word, string WordReplace)
{
    short pos = String.find(Word);
    while (pos != string::npos)
    {
        String = String.substr(0, pos) + WordReplace + String.substr(pos + Word.length(), String.length());
        pos = String.find(Word);
    }
    return String;
}
string FormateDate(sDate Date, string Format = "dd/mm/yyyy")
{
