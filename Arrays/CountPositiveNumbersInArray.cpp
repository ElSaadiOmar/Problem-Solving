// Problem: Count how many positive numbers are in an array.
// Array is filled with both negative and positive random values.
...
int CountPositive(int Array[100], int Arrlength)
{
    int counter = 0;
    for (int i = 0; i < Arrlength; i++)
    {
...
int main()
{
    ...
    cout << "Positive numbers count is : " << CountPositive(Array, Arrlength);
