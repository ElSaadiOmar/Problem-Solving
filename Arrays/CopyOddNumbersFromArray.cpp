// Problem: Copy only the odd numbers from one array into a new array.
// Filters elements using the modulus operator before appending.
...
void CopyOddNumber(int Arr1[100], int Arr2[100], int Arrlength, int &Arrlength2)
{
    for (int i = 0; i < Arrlength; i++)
    {
        if ((Arr1[i] % 2) != 0)
